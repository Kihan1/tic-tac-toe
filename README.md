# tic-tac-toe
A simple game to keep you occupied when bored


I have used HTML,CSS & JAVASCRIPT to build this piece of project....

Here is a summary of the tags and functions i used to develop this project, Pass through this document it can be of help.
